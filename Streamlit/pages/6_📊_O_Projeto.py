...
st.write("**Cursos** - A análise dos dados em perspectiva histórica permite identificar que entre 2012 e 2022, houve um aumento da oferta de cursos, enquanto o número de matrículas apresentou uma tendência de redução nas instituições privadas. Também foi possível observar que após 2020 houve aumento na oferta de cursos e matrículas na área da saúde. Conjectura-se a relação dessa tendência com a pandemia por Covid-19, porém não há subsídios para a confirmação desta hipótese.")
